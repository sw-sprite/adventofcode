...
if __name__ == "__main__":
    ...
    #     sample_stacks[int(instructions[5])-1] = sample_stacks[int(instructions[3])-1][:int(instructions[1])] + sample_stacks[int(instructions[5])-1]
    #     sample_stacks[int(instructions[3])-1] = sample_stacks[int(instructions[3])-1][int(instructions[1]):] 
    ...
    for i in lines:
        ...
        stacks[int(instructions[5])-1] = stacks[int(instructions[3])-1][:int(instructions[1])] + stacks[int(instructions[5])-1]
        stacks[int(instructions[3])-1] = stacks[int(instructions[3])-1][int(instructions[1]):] 
